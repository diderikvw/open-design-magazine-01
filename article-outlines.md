...
Open Source is a term widely used, that stands for more than one meaning. (1) Is a development collaborative model originated from software development practices, (2) It stands for a set of licenses that allow users to access the know-how behind software and hardware (source-code,files, models and documentation) and gives essential freedoms, including the freedom to use, study, improve the code, and distribute it; and (3) is an economic phenomenon, an industry if you like, that has disrupted traditional production workflows. The result and combination has been the explosion of what is today known as the collaborative commons. It is a new industrial revolution also known as the p2p phenomenon. Can this new industrial revolution and productive model bring fundamental impact towards improving well-being for everyone today while preserving natural resources and ecosystems for future generations? In this article we examine the potential this phenomenon has towards sustainable development, what contradictions, challenges, and opportunities unfold from it.
